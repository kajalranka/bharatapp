...
// const ParkingBooking = ({ isOpen, onClose, selectedMarker }) => {
//   const [startTime, setStartTime] = useState('');
//   const [endTime, setEndTime] = useState('');
//   const [selectedSlot, setSelectedSlot] = useState('');
...
//   const slotId = selectedMarker?.id;
...
//         <button onClick={() => handlePayment(slotId, navigate)} className="book-button">Book now</button>
//       </div>
//     </div>,
//     document.body
//   );
